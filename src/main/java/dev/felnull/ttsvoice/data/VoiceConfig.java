...
public record VoiceConfig(boolean enableVoiceVox, boolean enableCoeiroInk, boolean enableShareVox,
                          boolean enableVoiceText,
                          boolean enableGoogleTranslateTts, boolean enableInm, boolean enableCookie) {
    public static VoiceConfig createDefault() {
        return new VoiceConfig(true, true, true, true, true, true, true);
    }
    ...
    public static VoiceConfig of(JsonObject jo) {
        ...
        boolean enableShareVox = jo.getBoolean("ShareVox", true);
        ...
        return new VoiceConfig(enableVoiceVox, enableCoeiroInk, enableShareVox, enableVoiceText, enableGoogleTranslateTts, enableInm, enableCookie);
    }
    ...
    public JsonObject toJson() {
        ...
        jo.put("ShareVox", JsonPrimitive.of(enableShareVox));
